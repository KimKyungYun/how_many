...
function App() {
  ...
  const handleTime = () => {
    ...
    if (method === 'today') return Math.floor(passedTIme*10000000)/100000;
    return ( new Date().getDay() + passedTIme)>5?5:Math.floor( (new Date().getDay() + passedTIme)*2000000)/100000;
